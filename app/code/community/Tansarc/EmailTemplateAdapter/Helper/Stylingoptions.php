 ...
 */
class Tansarc_EmailTemplateAdapter_Helper_Stylingoptions
{
    /**
    ...
    protected function _isEncodedArrayFieldValue($value)
    {
        ...
        foreach ($value as $_id => $row) {
            if (!is_array($row) || !array_key_exists('html_element', $row) || !array_key_exists('inline_style', $row)) {
                return false;
            }
        }
        return true;
    ...
    protected function _decodeArrayFieldValue(array $value)
    {
        ...
        foreach ($value as $_id => $row) {
            ...
            $groupId = $row['html_element'];
            $qty = $row['inline_style'];
            $result[$groupId] = $qty;
        }
        return $result;
    }
